...
114 CSS custom properties from @nicarunner/ui. Names are
preserved verbatim from upstream. They are declared inside `_ds_bundle.css` (this DS ships one compiled stylesheet rather than separate token files).

- **color** (62): `--tw-border-style`, `--tw-shadow-color`, `--tw-inset-shadow-color`, …
- **spacing** (4): `--tw-inset-shadow`, `--tw-inset-shadow-alpha`, `--tw-inset-ring-shadow`, …
- **typography** (9): `--tw-font-weight`, `--tw-tracking`, `--font-sans`, …
- **radius** (1): `--radius-lg`
- **shadow** (7): `--tw-shadow`, `--tw-shadow-alpha`, `--tw-ring-shadow`, …
- **other** (31): `--tw-rotate-x`, `--tw-rotate-y`, `--tw-rotate-z`, …
