...
namespace NicaRunner.Infrastructure.Migrations
{
    ...
    [Migration("20260902033300_AddResultArrivalClockOrigin")]
    partial class AddResultArrivalClockOrigin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NicaRunner.Domain.Entities.AdminNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("CreatedAt")
                        .IsDescending()
                        .HasDatabaseName("IX_AdminNotification_Created");

                    b.HasIndex("ReadAt")
                        .HasDatabaseName("IX_AdminNotification_ReadAt");
            ...
            modelBuilder.Entity("NicaRunner.Domain.Entities.Result", b =>
                {
                    ...
                    b.Property<int?>("DisputeGroupId")
                        .HasColumnType("integer");

                    b.Property<string>("DisputeMotivo")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)");
                    ...
                    b.Property<string>("DorsalPropuesto")
                        .HasMaxLength(32)
                    ...
                    b.Property<int?>("TiempoOffsetConfianzaMs")
                        .HasColumnType("integer");

                    b.Property<string>("TiempoOrigen")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)");
            ...
            modelBuilder.Entity("NicaRunner.Domain.Entities.Result", b =>
                {
                    ...
                    b.HasOne("NicaRunner.Domain.Entities.Result", null)
                        .WithMany()
                        .HasForeignKey("DisputeGroupId")
                        .OnDelete(DeleteBehavior.Restrict);
