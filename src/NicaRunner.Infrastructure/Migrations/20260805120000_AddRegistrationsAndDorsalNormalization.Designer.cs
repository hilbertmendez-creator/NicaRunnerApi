...
namespace NicaRunner.Infrastructure.Migrations
{
    ...
    [Migration("20260805120000_AddRegistrationsAndDorsalNormalization")]
    partial class AddRegistrationsAndDorsalNormalization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NicaRunner.Domain.Entities.Registration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NicaRunner.Domain.Entities.RegistrationLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NicaRunner.Domain.Entities.ReservedDorsal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("DorsalNormalizado")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("RaceId", "DorsalNormalizado")
                        .IsUnique()
                        .HasDatabaseName("IX_ReservedDorsals_RaceId_DorsalNormalizado");

                    b.ToTable("ReservedDorsals");
                });
            ...
            modelBuilder.Entity("NicaRunner.Domain.Entities.Registration", b =>
                {
                    ...
                    b.HasOne("NicaRunner.Domain.Entities.RaceCategory", "RaceCategory")
                        .WithMany()
                        .HasForeignKey("RaceCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NicaRunner.Domain.Entities.User", "RevisadoPor")
                        .WithMany()
